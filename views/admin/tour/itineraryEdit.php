...
<div class="container-fluid px-4">
    ...
    <p class="page-subtitle">
        Phiên bản tour: <strong><?= htmlspecialchars($data_itinerary['version_name']) ?></strong>
    </p>
            ...
            <form method="post">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number"
                                ...
                                value="<?= htmlspecialchars($old['day_number'] ?? $data_itinerary['day_number']) ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                value="<?= htmlspecialchars($old['place'] ?? $data_itinerary['place']) ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time"
                                ...
                                value="<?= htmlspecialchars($old['start_time'] ?? $data_itinerary['start_time']) ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time"
                                ...
                                value="<?= htmlspecialchars($old['end_time'] ?? $data_itinerary['end_time']) ?>">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="activity"
                        ...
                        rows="5"><?= htmlspecialchars($old['activity'] ?? $data_itinerary['activity']) ?></textarea>
